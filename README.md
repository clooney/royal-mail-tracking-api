...
In order to use this API, you need to generate a Royal Mail Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code.  use  Royal Mail Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Royal Mail Tracking API](https://www.trackingmore.com/royal-mail-tracking.html)  to:

   *   Get Royal Mail realtime tracking info of muti-carriers in one integration
   *   Provide Royal Mail shipment tracking experience like Amazon
   *   Push Royal Mail  notifications of package update with webhook
   *   Verify Royal Mail delivery exception before it is too late
